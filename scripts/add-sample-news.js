...
const sampleNews = [
  {
    ...
    content: "Un perro mestizo fue encontrado con heridas graves en la zona norte de la ciudad. Necesita cirugía urgente para salvar su vida. Los veterinarios estiman que el costo será de 800€. Cualquier donación es bienvenida para ayudar a este pequeño luchador. El perro está actualmente en la clínica veterinaria San Francisco recibiendo cuidados intensivos.",
  ...
  },
  {
    ...
    content: "Luna es una Golden Retriever de 3 años que se perdió el pasado sábado en el parque central. Lleva collar azul con su nombre y número de teléfono. Es muy cariñosa y responde a su nombre. Si la has visto, por favor contacta inmediatamente al 612-345-678. Su familia la está buscando desesperadamente.",
  ...
  },
  {
    ...
    content: "Después de 5 días de búsqueda intensiva, Max, el pastor alemán que se había perdido, fue encontrado sano y salvo. Una familia lo encontró refugiándose bajo un puente y reconoció las fotos que habíamos compartido. Max ya está de vuelta en casa con su familia, quien no puede estar más agradecida por toda la ayuda recibida.",
  ...
  },
  {
    ...
    content: "Gracias a las donaciones recibidas el mes pasado, hemos podido abrir un nuevo refugio temporal en el distrito sur de la ciudad. Este espacio nos permitirá albergar hasta 20 animales adicionales mientras encuentran hogar. El refugio cuenta con todas las comodidades necesarias y un equipo de voluntarios dedicados al cuidado de los animales.",

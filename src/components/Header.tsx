        ...
        <div className='flex flex-col items-center justify-between gap-6 lg:flex-row'>
          <Link href='/'>
            <div className='flex items-center gap-4'>
              ...
              />
              <h1 className='text-5xl font-bold font-sans tracking-wide text-primary animate-color-change'>
                Protectora Fido
              </h1>
            </div>
          </Link>
          ...
          <nav className='flex items-center gap-6'>
            ...
            <Link
              ...
              className='bg-green-500 hover:bg-green-600 text-white self-start px-4 py-2 rounded-md font-semibold transition-colors duration-200'
            >
              Ayudanos
            </Link>
          </nav>

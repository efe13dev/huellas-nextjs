      ...
      const sampleNews: NewsItem[] = [
        {
          ...
          content: "Un perro mestizo fue encontrado con heridas graves en la zona norte de la ciudad. Necesita cirugía urgente para salvar su vida. Los veterinarios estiman que el costo será de 800€. Cualquier donación es bienvenida para ayudar a este pequeño luchador.",
        ...
        },
        {
          ...
          content: "Luna es una Golden Retriever de 3 años que se perdió el pasado sábado en el parque central. Lleva collar azul con su nombre y número de teléfono. Es muy cariñosa y responde a su nombre. Si la has visto, por favor contacta inmediatamente.",
        ...
        },
        {
          ...
          content: "Después de 5 días de búsqueda intensiva, Max, el pastor alemán que se había perdido, fue encontrado sano y salvo. Una familia lo encontró refugiándose bajo un puente y reconoció las fotos que habíamos compartido.",
        ...
        },
        {
          ...
          content: "Bella, la gata que rescatamos hace 3 meses, finalmente ha encontrado su familia perfecta. Después de un proceso de adopción cuidadoso, ahora vive feliz con una pareja joven que le da todo el amor que merece.",
        ...
        },
        {
          ...
          content: "Este sábado 20 de enero estaremos en el centro comercial Plaza Norte de 10:00 a 18:00 con varios perritos y gatitos buscando hogar. Ven a conocerlos, tal vez encuentres a tu nuevo mejor amigo.",
        ...
        },
        {
          ...
          content: "En colaboración con la clínica veterinaria municipal, ofrecemos vacunación gratuita para mascotas de familias con recursos limitados. La campaña incluye vacunas básicas, desparasitación y revisión general.",
        ...
        },
        {
          ...
          content: "Gracias a las donaciones recibidas el mes pasado, hemos podido abrir un nuevo refugio temporal en el distrito sur de la ciudad. Este espacio nos permitirá albergar hasta 20 animales adicionales mientras encuentran hogar.",
